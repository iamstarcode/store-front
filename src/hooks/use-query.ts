...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetCollectionsRoot(variables?: GetCollectionsRootQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetCollectionsRootQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCollectionsRootQuery>(GetCollectionsRootDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetCollectionsRoot', 'query', variables);
    },
    GetProductsFragment(variables?: GetProductsFragmentQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetProductsFragmentQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductsFragmentQuery>(GetProductsFragmentDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetProductsFragment', 'query', variables);
    },
    GetProductsNewArrivals(variables?: GetProductsNewArrivalsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetProductsNewArrivalsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductsNewArrivalsQuery>(GetProductsNewArrivalsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetProductsNewArrivals', 'query', variables);
    }
  };
}
