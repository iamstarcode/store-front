...
export type GetCollectionsRootQuery = {
  __typename?: "Query"
  collections: {
    __typename?: "CollectionList"
    items: Array<{
...
export type ProductsFragmentFragment = {
  ...
  name: string
  slug: string
  variants: Array<{ __typename?: "ProductVariant"; price: any }>
  assets: Array<{ __typename?: "Asset"; source: string; preview: string }>
}
...
export type GetProductsFragmentQuery = {
  __typename?: "Query"
  products: {
    __typename?: "ProductList"
    items: Array<{
...
export type GetProductsNewArrivalsQueryVariables = Exact<{
  [key: string]: never
}>

export type GetProductsNewArrivalsQuery = {
  __typename?: "Query"
  products: {
    __typename?: "ProductList"
    items: Array<{
...
export function getSdk(
  ...
  return {
    GetCollectionsRoot(
      variables?: GetCollectionsRootQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetCollectionsRootQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCollectionsRootQuery>(
            GetCollectionsRootDocument,
            variables,
    ...
    GetProductsFragment(
      variables?: GetProductsFragmentQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetProductsFragmentQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProductsFragmentQuery>(
            GetProductsFragmentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetProductsFragment",
    ...
    GetProductsNewArrivals(
      variables?: GetProductsNewArrivalsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetProductsNewArrivalsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProductsNewArrivalsQuery>(
            GetProductsNewArrivalsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetProductsNewArrivals",
...
export function getSdkWithHooks(
  ...
  return {
    ...sdk,
    useGetCollectionsRoot(
      variables?: GetCollectionsRootQueryVariables,
      config?: SWRConfigInterface<GetCollectionsRootQuery, ClientError>
    ) {
      return useSWR<GetCollectionsRootQuery, ClientError>(
        genKey<GetCollectionsRootQueryVariables>(
          "GetCollectionsRoot",
          variables
        ),
        () => sdk.GetCollectionsRoot(variables),
        config
      )
    },
    useGetProductsFragment(
      variables?: GetProductsFragmentQueryVariables,
      config?: SWRConfigInterface<GetProductsFragmentQuery, ClientError>
    ) {
      return useSWR<GetProductsFragmentQuery, ClientError>(
        genKey<GetProductsFragmentQueryVariables>(
          "GetProductsFragment",
          variables
        ),
        () => sdk.GetProductsFragment(variables),
        config
      )
    },
    useGetProductsNewArrivals(
      variables?: GetProductsNewArrivalsQueryVariables,
      config?: SWRConfigInterface<GetProductsNewArrivalsQuery, ClientError>
    ) {
      return useSWR<GetProductsNewArrivalsQuery, ClientError>(
        genKey<GetProductsNewArrivalsQueryVariables>(
          "GetProductsNewArrivals",
          variables
        ),
        () => sdk.GetProductsNewArrivals(variables),
        config
      )
    },
  }
